...
static int cdvdman_start_async_read(u32 lsn, u32 sectors, u16 sector_size, void *buf, int allow_pending)
{
...
{
    return cdvdman_start_async_read(lsn, sectors, sector_size, buf, 1);
}

int cdvdman_AsyncReadNoPending(u32 lsn, u32 sectors, u16 sector_size, void *buf)
{
    return cdvdman_start_async_read(lsn, sectors, sector_size, buf, 0);
}
